...
event_comparison <- data.table(definition = factor(c("Q80/Q95", "Mean/Q95", "Mean/Q95*", "Q95", "Q95*", "Q80"), 
...
write.csv(event_comparison,  paste0(PATH_OUTPUT_TABLES, region, '_definition_properties_ind_gleam4.csv'))

##Compare change 
#up_to_2001
event_comparison_1 <-data.table(definition = factor(c("Q80/Q95", "Mean/Q95", "Mean/Q95*", "Q95", "Q95*", "Q80"), 
                                                    levels = c("Q80/Q95", "Mean/Q95", "Mean/Q95*", "Q95", "Q95*", "Q80")))
event_comparison_1$frequency <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', unique(event_80_95_id), .(grid_id)][, .N, grid_id]$N),
...
event_comparison_1$duration_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_1$duration_max <- c(
  max(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_1$extreme_n <- round(c(  #### Extremes per event
  mean(exeves[!is.na(extreme_id) & period == 'up_to_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_1$extreme_n_max <- round(c(  #### Extremes per event
  max(exeves[!is.na(extreme_id) & period == 'up_to_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_1$intensity_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', mean(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_1$intensity_max <- round(c(
  max(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', mean(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_1$severity_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', sum(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_1$severity_max <- round(c(
  max(exeves[!is.na(event_80_95_id) & period == 'up_to_2001', sum(value), .(grid_id, event_80_95_id)]$V1),
...
#after_2001
event_comparison_2 <-data.table(definition = factor(c("Q80/Q95", "Mean/Q95", "Mean/Q95*", "Q95", "Q95*", "Q80"), 
                                                    levels = c("Q80/Q95", "Mean/Q95", "Mean/Q95*", "Q95", "Q95*", "Q80")))
event_comparison_2$frequency <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'after_2001', unique(event_80_95_id), .(grid_id)][, .N, grid_id]$N),
...
event_comparison_2$duration_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'after_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_2$duration_max <- c(
  max(exeves[!is.na(event_80_95_id) & period == 'after_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_2$extreme_n <- round(c(  #### Extremes per event
  mean(exeves[!is.na(extreme_id) & period == 'after_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_2$extreme_n_max <- round(c(  #### Extremes per event
  max(exeves[!is.na(extreme_id) & period == 'after_2001', .N, .(grid_id, event_80_95_id)]$N),
...
event_comparison_2$intensity_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'after_2001', mean(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_2$intensity_max <- round(c(
  max(exeves[!is.na(event_80_95_id) & period == 'after_2001', mean(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_2$severity_mean <- round(c(
  mean(exeves[!is.na(event_80_95_id) & period == 'after_2001', sum(value), .(grid_id, event_80_95_id)]$V1),
...
event_comparison_2$severity_max <- round(c(
  max(exeves[!is.na(event_80_95_id) & period == 'after_2001', sum(value), .(grid_id, event_80_95_id)]$V1),
...
write.csv(event_comparison_change,  paste0(PATH_OUTPUT_TABLES, region, '_definition_change_ind_gleam4.csv'))
