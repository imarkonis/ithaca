...
saveRDS(exeves_changes_summary, file = paste0(PATH_OUTPUT, 'monthly_changes_ind_gleam4.rds'))
saveRDS(exeves_changes_mean_summary, file = paste0(PATH_OUTPUT, 'monthly_changes_mean_ind_gleam4.rds'))
