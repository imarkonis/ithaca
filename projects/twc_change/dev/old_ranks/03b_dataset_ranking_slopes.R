...
prec_comparison[, bias_slope := abs(sen_slope - ens_slope_median) / abs(ens_slope_median)]
...
evap_comparison[, bias_slope := abs(sen_slope - ens_slope_median) / abs(ens_slope_median)]
