...
data_levels <- rev(c("GPM IMERG v7", "GPCP CDR v3.2", "MSWEP v2.8",
                     "MERRA-2 Land", "MERRA-2", "PERSIANN CDR", "EM-Earth",
                     "FLDAS", "CMAP", "PREC/L", "ERA5-Land", "CPC-Global",
                     "CRU TS v4.08", "TerraClimate", "GPCC FD v2022", "ERA5",
