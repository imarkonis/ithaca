...
data_levels <- rev(c("GPM-IMERG v7", "MSWEP v2.8", "MERRA-2 Land", "FLDAS",
                     "CRU TS v4.07", "EM-Earth", "PERSIANN-CDR", "PREC/L",
                     "TerraClimate", "GPCC v2020", "ERA5-Land", "CPC-Global",
                     "CMAP", "JRA-55", "ERA5", "GPCP v3.2", "GSMaP v8",
